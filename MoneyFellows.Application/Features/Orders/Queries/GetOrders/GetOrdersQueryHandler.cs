...
{
    public class GetOrdersQueryHandler : IRequestHandler<GetOrdersQuery, Response<ListingDto<OrderDto>>>
    {
        public IOrderRepository _orderRepository { get; }
        public IMapper _mapper { get; }
        public ILogger _logger { get; }

        public GetOrdersQueryHandler(IOrderRepository orderRepository, IMapper mapper, ILogger logger)
        {
        ...
        public async Task<Response<ListingDto<OrderDto>>> Handle(GetOrdersQuery request, CancellationToken cancellationToken)
        {
            try
            {
